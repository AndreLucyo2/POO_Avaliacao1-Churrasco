...
public class Pessoa
{
    ...
    //Associação MUITOS eventos com nome churrasco     
    private ArrayList<Confraternizacao> eventos = new ArrayList<Confraternizacao>();
    ...
    public ArrayList<Confraternizacao> getEventos()
    {
	return eventos;
    }
    ...
    {
	return "Pessoa{" + "id=" + id + ", nome=" + nome + ", sexo=" + sexo + ", idade=" + idade + ", eventos=" + eventos + '}';
    }
